...
So: include I(EDUC^2) and I(AGE^2) in the pref


```{r interaction effects, echo=FALSE,results='asis'}
int_model <-lm(WAGE~ EDUC + AGE + RACE + EDUC*AGE + EDUC*RACE +SMSA + MARRIED + REGION2 + REGION3 + REGION4 + REGION5 + REGION6 + REGION7 + REGION8 + REGION9  , data = df)
...
REGION8 = as.integer(REGION == 8),
REGION9 = as.integer(REGION == 9))
best_mod <- int_model <-lm(log(WAGE)~ EDUC + I(EDUC^2) + AGE + I(AGE^2) + RACE + EDUC*AGE + EDUC*RACE +SMSA + MARRIED + REGION2 + REGION3 + REGION4 + REGION5 + REGION6 + REGION7 + REGION8 + REGION9  , data = df)
