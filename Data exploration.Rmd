...
cat("H0: A(REGION) $\\leq$ 0 → There are no positive wage differences across regions.\n\n")
cat("H1: A(REGION) $>$ 0 → At least one region has a positive effect on wages.\n\n")
cat("One-sided test: Certain regions, especially those that are economically stronger or more urbanized, may offer higher wages.\n\n")
