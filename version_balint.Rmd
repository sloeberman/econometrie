...
# Step 1: Specification, hypotheses, and descriptive statistic
...
```{r corr matrix , echo=FALSE, results='markup', message=FALSE}
correlation_matrix <- cor(df[, c("EDUC", "AGE", "RACE", "SMSA", "MARRIED", 
                                 "REGION2", "REGION3", "REGION4", "REGION5", 
                                 "REGION6", "REGION7", "REGION8", "REGION9")])

print(round(correlation_matrix, 5))
```
...
effect of education on wages cannot be reliably identified in this model.
