...
LM_reg=lm(res~EDUC+I(EDUC^2)+I(EDUC^3)+ AGE + RACE + SMSA + MARRIED + REGION2 + REGION3 
                 + REGION4 + REGION5 + REGION6 + REGION7 + REGION8 + REGION9, data = df)
...
REGION8 = as.integer(REGION == 8),
REGION9 = as.integer(REGION == 9))
best_mod <- lm(log(WAGE)~ EDUC + I(EDUC^2) + I(EDUC^3)+I(EDUC^4) + AGE + RACE + I(EDUC*RACE) +SMSA + MARRIED + REGION2 + REGION3 + REGION4 + REGION5 + REGION6 + REGION7 + REGION8 + REGION9, data = df)
