...
final_model <- ivreg(log(WAGE) ~ EDUC + EDUC^2 + AGE + RACE + MARRIED + SMSA + factor(REGION) + EDUC:RACE | QOB + QOB^2 + QOB:RACE + AGE + RACE + MARRIED + SMSA + factor(REGION),
                  data = df)


stargazer(final_model, type = "text", digits = 4, style = "all")
```
